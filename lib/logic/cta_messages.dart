/// CTA messages for Vivian — personalized, cute, playful, sarcastic.
/// App flow: empty, daily focus, long-term focus, end of day.
class CTAMessages {
  CTAMessages._();
  ...
  // ---------- Long-term in progress (during focus hour) ----------
  ...
  /// Progress-label snippets when we inject "You're at X/Y" — used by CTAEngine.
  static const List<String> progressLabelPrefixes = [
  ...
  static const List<String> progressLabelSuffixes = [
